...
| 3 | Initial publication store and loader | `bf7f39b`, `5c8bf2b`, `f2d5eca`, `85272bc` | Initial release only. Preserve the deliberate incremental block. Migrations, roles, loader, atomic activation, cleanup, and live PostGIS tests travel together. |
