...
CREATE TABLE occurrences_staging (
    ...
    is_sensitive      BOOLEAN NOT NULL DEFAULT FALSE,  -- placeholder flag
    date_mdb_modified TIMESTAMPTZ NOT NULL      -- enforced NOT NULL tracking timestamp
);

-- =============================================================================
-- 2. Sample rows — ALL INVENTED with explicit timestamps for NOT NULL compliance.
-- =============================================================================
...
(1, 100, 'Erithacus rubecula', 'Robin',       'birds',
    2024, 358400, 172600, 'A. Example', 'Test Park',  TRUE,  FALSE, '2026-08-09 10:00:00+00'),

(2, 100, 'Erithacus rubecula', 'Robin',       'birds',
    2023, 359100, 173200, 'B. Example', 'Test Green', TRUE,  FALSE, '2026-08-09 10:00:00+00'),

(3, 100, 'Erithacus rubecula', 'Robin',       'birds',
    2022, 357800, 171900, 'A. Example', 'Test Wood',  FALSE, FALSE, '2026-08-09 10:00:00+00'),

(4, 200, 'Bufo bufo', 'Common Toad', 'amphibians',
    2024, 360200, 174100, 'C. Example', 'Test Pond',  TRUE,  FALSE, '2026-08-09 10:00:00+00'),

(5, 200, 'Bufo bufo', 'Common Toad', 'amphibians',
    2021, 361000, 174800, 'C. Example', 'Test Ditch', TRUE,  FALSE, '2026-08-09 10:00:00+00'),

-- A deliberately "sensitive" row:
(6, 300, 'Lutra lutra', 'Otter', 'mammals',
    2025, 356500, 170300, 'D. Example', 'Test River', TRUE,  TRUE,  '2026-08-09 10:00:00+00'),

(7, 300, 'Lutra lutra', 'Otter', 'mammals',
    2024, 356900, 170700, 'D. Example', 'Test Bank',  FALSE, TRUE,  '2026-08-09 10:00:00+00');
