...
INSERT INTO brerc_source.occurrences
    (unique_no, species_no, scientific_name, nbn_number, record_type, sensitive,
     verified, eastings, northings, date_of_record, date_mdb_modified,
     recorder1, place, comments) VALUES
    ...
    ('R001', '6973', 'Erithacus rubecula', 'NBNSYS0000000001', 'field record', 'No',
     'Accepted', 358720, 172480, DATE '2024-05-14', TIMESTAMPTZ '2026-08-01 09:00:00+01',
    ...
    ('R002', '7101', 'Bufo bufo', 'NBNSYS0000000002', 'field record', 'No',
     'Accepted', 360740, 174880, DATE '2024-03-02', TIMESTAMPTZ '2026-08-01 09:00:00+01',
    ...
    ('R003', '8319', 'Lutra lutra', 'NBNSYS0000000003', 'field record', 'Yes',
     'Accepted', 356123, 171456, DATE '2025-06-20', TIMESTAMPTZ '2026-08-01 09:00:00+01',
    ...
    ('R004', '8412', 'Meles meles', 'NBNSYS0000000004', 'sett', 'No',
     'Accepted', 359001, 173002, DATE '2025-04-11', TIMESTAMPTZ '2026-08-01 09:00:00+01',
    ...
    ('R005', 'BRERC0001', 'Apus apus', NULL, 'field record', 'No',
     'Accepted', 358100, 172900, DATE '2024-07-03', TIMESTAMPTZ '2026-08-01 09:00:00+01',
    ...
    ('R006/A', '6973', 'Erithacus rubecula', 'NBNSYS0000000001', 'field record', 'No',
     'Unverified', 357400, 171100, DATE '2023-11-30', TIMESTAMPTZ '2026-08-01 09:00:00+01',
    ...
    ('R007', '404404', 'Ignotus incognitus', NULL, 'field record', 'No',
     'Accepted', 361000, 175000, DATE '2025-01-15', TIMESTAMPTZ '2026-08-01 09:00:00+01',
