-- =============================================================================
-- B6 SEED SAMPLE — INVENTED rows for local development / demo / CI only.
-- =============================================================================
...
-- Per-record public rows (includes Load and Load_date).
-- date_mdb_modified is NOT NULL: it is BRERC's own "last modified" timestamp for
-- each record, and the pipeline diffs on it to work out what changed since the
-- previous run. Real rows get it from the source database; these invented rows
-- just need a plausible value, set here to shortly before the load that brought
-- them in.
INSERT INTO occurrence_public (record_id, species_id, record_year, grid_ref,
                               ...
                               "Load", "Load_date") VALUES
    (1, 100001, 2024, 'ST5872', 1000,  'Bristol (ST58)',               true,  md5('1|100001|2024|ST5872'), '2026-08-01 10:00:00', 'initial', '2026-08-09 00:00:00'),
    (2, 100001, 2023, 'ST5973', 1000,  'Bristol (ST59)',               true,  md5('2|100001|2023|ST5973'), '2026-08-02 10:00:00', 'initial', '2026-08-09 00:00:00'),
    (3, 100001, 2022, 'ST5771', 1000,  'Bristol (ST57)',               false, md5('3|100001|2022|ST5771'), '2026-08-03 10:00:00', 'initial', '2026-08-09 00:00:00'),
    (4, 100002, 2024, 'ST6074', 1000,  'South Gloucestershire (ST60)', true,  md5('4|100002|2024|ST6074'), '2026-08-04 10:00:00', 'initial', '2026-08-09 00:00:00'),
    (5, 100002, 2021, 'ST61',   10000, 'South Gloucestershire (ST61)', true,  md5('5|100002|2021|ST61'),   '2026-08-05 10:00:00', 'initial', '2026-08-09 00:00:00'),
    (6, 100003, 2025, 'ST5',    10000, 'Bristol area (ST)',            true,  md5('6|100003|2025|ST5'),    '2026-08-06 10:00:00', 'initial', '2026-08-09 00:00:00'),
    (7, 100003, 2024, 'ST5',    10000, 'Bristol area (ST)',            false, md5('7|100003|2024|ST5'),    '2026-08-07 10:00:00', 'initial', '2026-08-09 00:00:00');

-- Pre-aggregated grid cells.
