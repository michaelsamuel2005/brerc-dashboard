// Hand-authored fixtures mirroring the required PUBLIC contract shape. By construction
// they contain NO Recorder1/BLISS/Eastings/Northings/Comments and NO sensitivity marker.
// Everything is SYNTHETIC demo data.
//
// Distribution cells carry only an ID + counts — the client derives each square's polygon
// from the (validated) grid ID, so geometry always matches the ID. Every reference is at
// or coarser than the 100 m public floor. The individual-records list is a small SAMPLE of
...
// A SAMPLE of 8 individual records out of 186. Each grid reference is a 100 m square inside
// one of the cells below; all are at or coarser than the 100 m public floor.
...
// Real OS 1 km squares around south Bristol; Σ records = 186. IDs only — geometry derived
// client-side from each ID.
export const cellsFixture = {
  cells: [
    { cellId: "ST5872", precisionMetres: 1000, recordCount: 58, verifiedCount: 55 },
    { cellId: "ST5972", precisionMetres: 1000, recordCount: 44, verifiedCount: 42 },
    { cellId: "ST5773", precisionMetres: 1000, recordCount: 31, verifiedCount: 30 },
    { cellId: "ST6072", precisionMetres: 1000, recordCount: 22, verifiedCount: 21 },
    { cellId: "ST5871", precisionMetres: 1000, recordCount: 15, verifiedCount: 14 },
    { cellId: "ST5973", precisionMetres: 1000, recordCount: 9, verifiedCount: 9 },
    { cellId: "ST6172", precisionMetres: 1000, recordCount: 4, verifiedCount: 4 },
    { cellId: "ST5774", precisionMetres: 1000, recordCount: 3, verifiedCount: 3 },
  ],
