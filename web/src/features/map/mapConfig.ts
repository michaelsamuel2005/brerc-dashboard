...
// (basemap, colour ramp, zoom cap) are testable and centralised. Typed against maplibre.
import type {
  StyleSpecification,
...
export const INITIAL_VIEW = { longitude: -2.585, latitude: 51.468, zoom: 9.3 };
// Cap zoom at meaningful precision: cells are 1 km+, so deeper zoom would imply detail
// the data does not have (an honesty requirement, not just performance).
export const MAX_ZOOM = 12;
export const CELLS_SOURCE_ID = "cells";
...
export const cellsFillLayer: FillLayerSpecification = {
  id: "cells-fill",
  type: "fill",
...
export const cellsLineLayer: LineLayerSpecification = {
  id: "cells-line",
  type: "line",
  source: CELLS_SOURCE_ID,
  paint: { "line-color": "#0e4a2c", "line-width": 0.5, "line-opacity": 0.5 },
};
